...
ifeq (${CONFIG_USER_CFLAGS},)
    ...
    #CXXFLAGS += $(WARNINGS:%=-W%) -nostdinc $(call cc-option,-std=c++11,-std=gnu++98) -I$(SEL4_INCLUDEDIR)/c++/v1
    ...
    CFLAGS += -fno-stack-protector -fno-short-enums
    CXXFLAGS += -fno-stack-protector -fno-short-enums
else
...
# Object files
OBJFILES = $(ASMFILES:%.S=%.o) $(CFILES:%.c=%.o) $(CXXFILES:%.cpp=%.o) $(OFILES) $(RUST_TARGET)
